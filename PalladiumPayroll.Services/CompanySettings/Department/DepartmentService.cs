...
namespace PalladiumPayroll.Services.Department
{
    public class DepartmentService : IDepartmentService
    {
        ...
        public async Task<JsonResult> CreateDepartment(AddEditDepartmentRequestDTO request)
        {
            try
            {
        ...
        public async Task<JsonResult> EditDepartment(long departmentId, AddEditDepartmentRequestDTO request)
        {
            try
            {
                string normalizedName = request.DepartmentName?.Trim().ToLower();
